...
//
//#if defined(_WIN64)
//	void gcpuid(UINT64* cpuinfo, char* vendorstr); 
//#endif
//
...
//		}
//		else
//			printf("ERROR: Could not open IDE21201.VXD file,get the HdSerialNo Failed");
//		return FALSE;
...
//
//
//	long getHardDriveComputerID (char* pSerialNo,char* calId)
//	{
//		int done = FALSE;
//		// char string [1024];
//		__int64 id = 0;
...
//
//#endif
//		sprintf(calId,"%I64d",id);
//		strcpy(pSerialNo,HardDriveSerialNumber);
//
//		return (long) id;
//	}
//
//	void dump_buffer (const char* title,
//		const unsigned char* buffer,
//		int len)
//	{
//		int i = 0;
...
//
//
//	void getCPUSerialNo(char* pSerialNo)
//	{
//#if defined(_WIN64)
//		char serialNo[256]={0};
//		char vendor[13] = { 0 };    
...
//	
//		gcpuid(&flags, vendor);     
//		highFlags=*((UINT32*)(&flags));
//		lowFlags=*((UINT32*)(&flags)+1);
//		sprintf(serialNo,"%08X%08X",flags,lowFlags);
//		sprintf(pSerialNo,"%s-%s",vendor,serialNo);
//#else
//		unsigned   long   s1,s2;
//		unsigned   char   vendor_id[]="------------";
//		char   sel;
//
//		char cpuBuff1[256],cpuBuff2[256],myCpuBuff[1024],vernderBuff[256];
//		memset(cpuBuff1,0,256);
//		memset(cpuBuff2,0,256);
//		memset(myCpuBuff,0,256);
//		memset(vernderBuff,0,256);
//
//		sel='1';
//		switch(sel)
//		{
...
//			}
//			sprintf(vernderBuff,"%s",vendor_id);
//			__asm
//			{
//				mov   eax,01h
//					xor   edx,edx
...
//					mov   s2,eax
//			}
//			sprintf(cpuBuff1,"%08X%08X",s1,s2);
...
//					mov   s2,ecx
//			}
//			sprintf(cpuBuff2,"%08X%08X",s1,s2);
...
//		}
//
//		//strcat(myCpuBuff,vernderBuff);
//		strcat(myCpuBuff,cpuBuff1);
//		if(strcmp("0000000000000000",cpuBuff2))
//		{
//			//如果不全为0则需要复制拷贝
//			strcat(myCpuBuff,cpuBuff2);
//		}
//		strcpy(pSerialNo,myCpuBuff);
//#endif
//	}
//#ifdef	__cplusplus
//}
...
//
//	//id = getHardDriveComputerID (hdSerial,calHD);
//
//
//	memset(cpuSerial,0,256);
//	getCPUSerialNo(cpuSerial);
//
//	//printf("CPU SerialNo:%s\r\n",cpuSerial);
//	//printf("HD SerialNo:%s\r\n",hdSerial);
//	//printf("HDCAL SerialNo:%s\r\n",calHD);
//	//printf("ID:%d\n",id);
//	//Time();
//	
//	
//	strcpy(str,cpuSerial);
//    
//    return str;
//}