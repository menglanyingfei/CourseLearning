...
SOCKADDR_IN CNetLIXINGYANGChatDlg::m_addrSrv;
...
BEGIN_MESSAGE_MAP(CNetLIXINGYANGChatDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_OPEN, &CNetLIXINGYANGChatDlg::OnClickedButtonOpen)
END_MESSAGE_MAP()
...
void CNetLIXINGYANGChatDlg::OnClickedButtonOpen()
{
	// TODO:  在此添加控件通知处理程序代码
	// 文件路径
	CString fileName; 
